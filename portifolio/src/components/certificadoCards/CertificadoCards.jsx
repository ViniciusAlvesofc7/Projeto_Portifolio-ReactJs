...
const CertificadoCards = (props) => {
    return (
        ...
        <a href={props.link} target="_blank" rel="noopener noreferrer" className="certificado-card w-40 flex flex-col items-center bg-gray-900 rounded-lg hover:scale-110 transition-all duration-500 cursor-pointer border-b-[2px] border-cyan-600 ">
